...
public class Config extends WebMvcConfigurerAdapter {
    ...
    private Map<String, HtmlField> allAllowedFields;
    ...
    public void createAllAllowedFields(@Value("${org.osiam.html.form.fields:}") String[] allowedFields,
        ...
        Map<String, HtmlField> collectedFields = new HashMap<>();
        ...
        for (String field : allowedFields) {
            ...
            collectedFields.put(htmlField.getName(), htmlField);
        }

        if (!collectedFields.containsKey("email")) {
            htmlField = new HtmlField();
        ...
        if (!collectedFields.containsKey("password")) {
            htmlField = new HtmlField();
        ...
        final HtmlField confirmPasswordField = collectedFields.get("confirmPassword");
        ...
        if (!usernameEqualsEmail && !collectedFields.containsKey(fieldUserName)) {
            htmlField = new HtmlField();
            htmlField.setName(fieldUserName);
            htmlField.setRequired(false);
            collectedFields.put(htmlField.getName(), htmlField);
        } else if (usernameEqualsEmail && collectedFields.containsKey(fieldUserName)) {
        ...
        allAllowedFields = collectedFields;
    ...
    public Map<String, HtmlField> getAllAllowedFields() {
